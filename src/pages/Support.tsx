        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <a href="mailto:support@insureagent.com" className="text-sm text-purple-600 hover:underline">
                support@insureagent.com
              </a>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <a href="tel:+233123456789" className="text-sm text-purple-600 hover:underline">
                +233 123 456 789
              </a>
            </div>
          </div>
